            ...
            <div class="container" style="margin:auto">
                <div class="signup-content">
                    <form method="post" action="{{route('discount.store')}}" enctype="multipart/form-data" id="signup-form" class="signup-form">
                        ...
                        <div class="form-group">
                            <input type="text" class="form-input" name="discountPercent" id="discountPercent" placeholder="discountPercent" />

                        </div>
                        <div class="form-group">
                            <input type="text" class="form-input" name="active" id="active" placeholder="active" />
