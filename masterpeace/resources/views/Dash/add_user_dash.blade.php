                ...
                <div class="signup-content">
                    <form method="post" action="{{route('user.store')}}" enctype="multipart/form-data" id="signup-form" class="signup-form">
                        ...
                        <div class="form-group">
                            <input type="text" class="form-input" name="username" id="username" value='{{ old('username') }}' placeholder="UserName">
                        ...
                        <div class="form-group">
                            <input type="text" class="form-input" name="lastName" id="lastName" value='{{ old('lastName') }}' placeholder="LastName">
                            <span style="color:red">@error('lastName'){{ $message }} @enderror</span><br><br>
                        </div>
                        <div class="form-group">
                            <input type="text" class="form-input" name="phone" id="phone" value='{{ old('phone') }}' placeholder="Phone">
