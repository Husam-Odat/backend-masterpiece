        ...
        <section class="signup">
            ...
            <div class="container" style="margin:auto">
                <div class="signup-content">
                    <form method="post" action="{{route('inventory.store')}}" enctype="multipart/form-data" id="signup-form" class="signup-form">
                        @csrf
                        @method('post')
                        <h2 class="form-title mb-4" style="color: rgb(10, 10, 105); text-align: center; font-family:'Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif;">Add inventory</h2>
                        ...
                        <div class="form-group">
                            <input type="text" class="form-input" name="quantity" id="quantity" placeholder="quantity"/>
