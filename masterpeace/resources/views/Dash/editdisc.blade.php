                    ...
                    <form method="post" action="{{route('discount.update',$discount->id)}}" enctype="multipart/form-data"  id="signup-form"  class="signup-form">
                       ...
                       @csrf
                        ...
                        <div class="form-group">
                            <input type="text" class="form-input" name="name" value="{{ $discount->name }}" id="name" placeholder="volunteer name"/>
                        ...
                        <div class="form-group">	
                            <input type="text" class="form-input" name="description" value="{{ $discount->description}}" placeholder="Description"/>
                          
                        </div>
                        <div class="form-group">	
                            <input type="text" class="form-input" name="discountPercent" value="{{ $discount->discountPercent}}" placeholder="Description"/>
                          
                        </div>
                        <div class="form-group">	
                            <input type="text" class="form-input" name="active" value="{{ $discount->active}}" placeholder="Description"/>
                        ...
                        <div class="form-group">
                            ...
                            <img src="/images/{{ $discount->img }}" width="200px" class="mt-4">
