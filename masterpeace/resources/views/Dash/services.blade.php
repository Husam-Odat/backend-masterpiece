            ...
            <table class="table">
                ...
                <thead>
                    <tr>
                        ...
                        <th style="color: rgb(9, 9, 66);">SKU</th>
                        <th style="color: rgb(9, 9, 66);">categoryId</th>
                        <th style="color: rgb(9, 9, 66);">inventoryId</th>
                        <th style="color: rgb(9, 9, 66);">discountId</th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $sercvvolnteer->SKU}}</td>
                        <td>{{ $sercvvolnteer->categoryId}}</td>
                        <td>{{ $sercvvolnteer->inventoryId}}</td>
                        <td>{{ $sercvvolnteer->discountId}}</td>
