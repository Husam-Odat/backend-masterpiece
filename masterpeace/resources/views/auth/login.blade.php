                        ...
                        <div class="d-flex align-items-center h-custom-2 px-5 ms-xl-4 mt-5 pt-5 pt-xl-0 mt-xl-n5">
                            ...
                            <form style="width: 23rem;" method="POST" action="{{ route('login') }}">
                                ...
                                <div class="form-outline mb-4">
                                    ...
                                    <x-text-input id="email" class="block mt-1 w-full form-control form-control-lg"
                                ...
                                <div class="form-outline mb-4">
                                    ...
                                    <x-text-input id="password" class="block mt-1 w-full form-control form-control-lg"
                                ...
                                <div class="flex items-center justify-end mt-4">
                                    ...
                                    <x-primary-button class="ml-3 btn btn-info btn-lg btn-block">
                                        {{ __('Log in') }}
                                    </x-primary-button>
                                </div>
                                {{-- <div class="pt-1 mb-4">
                                ...
                                <p class="small mb-5 pb-lg-2"><a class="text-muted" href="#!">Forgot
                                        password?</a></p>
                                <p>Don't have an account? <a href="#!" class="link-info">Register here</a>
                                </p> --}}
...
{{-- <div class="newsletter">
       ...
       <a href="index.html"><img src="images/logoo.png" alt="image" width="107" height="75"></a>
                            ...
                            <ul class="flat-social">
                                <li><a href="https://www.facebook.com/husam0dat/"><i class="fa fa-facebook"></i></a>
                                </li>
