...
<meta charset="utf-8">
    ...
    <link rel="apple-touch-icon" type="image/x-icon" sizes="72x72" href={{ asset("./cart/img/apple-touch-icon-72x72-precomposed.png")}}>
    <link rel="apple-touch-icon" type="image/x-icon" sizes="114x114" href={{ asset("./cart/img/apple-touch-icon-114x114-precomposed.png")}}>
    <link rel="apple-touch-icon" type="image/x-icon" sizes="144x144" href={{ asset("./cart/img/apple-touch-icon-144x144-precomposed.png")}}>
...
<!-- 
				...
				<!-- SubHeader =============================================== -->
	<section class="parallax-window" id="short" data-parallax="scroll" data-image-src="./images/slider_1.1.jpg" data-natural-width="1400" data-natural-height="350">
	    <div id="subheader">
	        <div id="sub_content">
                    ...
                    <div id="cart_box">
                        ...
                        <table class="table table_summary">
                            <tbody>
                                <tr>
                                    <td>
                                        <a href="#0" class="remove_item"><i class="icon_minus_alt"></i></a> <strong>1x</strong> Astronaut Resin Wood Art Lamp, Spacecraft Custom Night Light
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td>
                                        <a href="#0" class="remove_item"><i class="icon_minus_alt"></i></a> <strong>2x</strong> Original Flower Oil Painting On Canvas
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td>
                                        <a href="#0" class="remove_item"><i class="icon_minus_alt"></i></a> <strong>1x</strong> Abstract Original Colorful Oil Painting On Canvas, Large Concise Art, Custom Gift Painting, Modern Textured Wall Art, Living room Home Decor
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td>
                                        <a href="#0" class="remove_item"><i class="icon_minus_alt"></i></a> <strong>2x</strong> 3D Flower Oil Painting On Canvas,Original White Cherry Flower,Large Wall Art, Palette Knife Painting,Textured Acrylic Painting,Handmade Art
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td>
                                        <a href="#0" class="remove_item"><i class="icon_minus_alt"></i></a> <strong>1x</strong> Original Colorful Textured Oil Painting on Canvas, Large Abstract Hand Painted Modern Acrylic Painting Boho Wall Art for Living Room Decor
                                    </td>
                                    <td>
